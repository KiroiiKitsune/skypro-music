...
export default function CategoryPage() {
  ...
  const playlistArr = arrOfSelection.find(
      ...
      <S.Container>
        <S.Main>
          ...
          <CenterBlock
            ...
            playListName={playlistArr.name}
            arrOfTracks={playlistArr.items}
            setCurrentTrack={setCurrentTrack}
          />
          <SideBar unvisible={isSkeleton} isSidebarCatVisible={false} />
        </S.Main>
        {currentTrack && (
          <AudioPlayer unvisible={isSkeleton} currentTrack={currentTrack} />
        )}
        <footer />
      </S.Container>
    </S.Wrapper>
